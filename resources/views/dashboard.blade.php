<x-app-layout>
    <div class="justify-start flex items-center">
        ...
        <div class="text-center rounded-tr-lg rounded-bl-lg mb-5 w-fit text-md sm:text-xl font-semibold text-slate-300 bg-red-500 py-2 px-4 shadow-md ml-10 inset-0">
        ...
        <div class="flex justify-end w-full mx-10">
            ...
            <div class="text-center md:flex hidden justify-end items-end rounded-tr-lg rounded-bl-lg mb-5 w-fit text-md sm:text-xl font-semibold text-slate-100 bg-red-500 py-2 px-4 shadow-md ml-10 ">
    ...
    <div class="flex justify-center pb-2 px-2 iPulang">
                    ...
                    <table class="table w-full text-sm sm:text-md hidden scale-100 md:scale-90" id="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                @elseif ($arr->absensi_type_masuk <= '08:00:00' ) <td>
                                    ...
                                    @elseif ($arr->absensi_type_masuk <= '14:00:00' ) <td>
                                        <div class="badge badge-success overflow-hidden">
                                            Masuk
                                        </div>
                                        </td>
        ...
        <div class="flex justify-end px-4 pb-2">
            ...
            <form action="{{ route('data.update', $arr->id) }}" method="POST" class="tooltip">
                @csrf
                @method('PUT')
                <button type="submit" class="bg-orange-600 flex justify-center shadow-md hover:bg-orange-700 text-white hover:shadow-sm px-2 py-1 text-xl rounded-full  transition all ease-out duration-100"><i class="ri-run-line font-sans"></i>Pulang
                </button>
            </form>
            @else
            @endif
            ...
            <form action="{{ route('lembur', $i->id) }}" method="POST" class="tooltip">
                @csrf
                @method('PUT')
                <button type="submit" class="bg-orange-600 flex justify-center shadow-md hover:bg-orange-700 text-white hover:shadow-sm px-2 py-1 text-xl rounded-full  transition all ease-out duration-100"><i class="ri-run-line font-sans"></i>Akhiri Lembur
                </button>
            </form>
            @else
            @endif
