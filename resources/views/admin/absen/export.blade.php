        ...
        <table class="absen">
            ...
            @else
                ...
                <tr>
                    ...
                    @if ($arr->shift_id == 1 && $arr->absensi_type_masuk <= '08:00:00')
                    <td>Masuk</td>
                    @else
                    <td>Telat</td>
                    @endif
        ...
        <table class="absen">
            ...
            @if ($arr->keterangan == "izin" )
                ...
                <tr>
                    ...
                    <td>{{ $arr->absensi_type_masuk }}</td>
                    <td>{{ $arr->absensi_type_pulang }}</td>
                    @if ($arr->shift_id == 2 && $arr->absensi_type_masuk <= '14:00:00')
                    <td>Masuk</td>
                    @else
                    <td>Telat</td>
                    @endif
