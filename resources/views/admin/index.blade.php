<x-app-layout>
	<div class="flex">
		...
		<x-main-div>
			...
			<span class="p-2 mt-2 py-1 px-2 rounded-br-xl shadow-sm text-sm font-semibold text-white"
					...
					<div class="grid grid-cols-4 grid-flow-row justify-items-center w-fit">
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuUser">
								<button id="btnUser" class="btn btn-warning w-full mt-5"><i class="ri-folder-user-line text-lg"></i>Menu
									User</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class=" flex flex-col justify-center gap-x-2 mx-2">
										<a href="{{ route('users.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-user-line text-lg"></i>Index
											User</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuDevisi">
								<button id="btnDevisi" class="btn btn-warning w-full mt-5"><i class="ri-group-2-line text-lg"></i> Menu
									Devisi</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2">
										<a href="{{ route('devisi.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-team-line text-lg"></i> Index
											Devisi</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuClient">
								<button id="btnClient" class="btn btn-warning w-full mt-5"><i class="ri-p2p-line text-lg"></i> Menu
									Client</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2">
										<a href="{{ route('data-client.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-user-5-line text-lg"></i> Index
											Client</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuShift">
								<button id="btnShift" class="btn btn-warning w-full mt-5"><i class="ri-timer-line text-lg"></i> Menu
									Shift</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2">
										<a href="{{ route('shift.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-timer-flash-line text-lg"></i> Index
											Shift</a>
							...
							<div>
								<div class="flex justify-center px-2 btnRuangan">
									<a href="{{ route('ruangan.index') }}" class="btn btn-warning w-full mt-5"><i
											class="ri-door-open-line text-lg"></i> Index Ruangan</a>
								</div>
							</div>
						</div>
						{{-- End Menu Ruangan --}}
							...
							<div>
								<div class="flex justify-center px-2 btnPoint">
									<a href="{{ route('point.index') }}" class="btn btn-warning w-full mt-5"><i
											class="ri-coins-line text-lg font-normal"></i> Index Point</a>
								</div>
							</div>
						</div>
						{{-- End Menu Ruangan --}}
							...
							<div>
								<div class="flex justify-center px-2 btnArea">
									<a href="{{ route('area.index') }}" class="btn btn-warning w-full mt-5"><i
											class="ri-map-pin-2-line text-lg"></i> Index Area</a>
								</div>
							</div>
						</div>
						{{-- End Menu area --}}
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuKerjasama">
								<button id="btnKerjasama" class="btn btn-warning w-full mt-5"><i class="ri-shake-hands-line text-lg"></i> Menu
									Kerjasama</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px]">
										<a href="{{ route('kerjasamas.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-hand-coin-line text-lg"></i> Index
											Kerjasama</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuAbsen">
								<button id="btnAbsen" class="btn btn-warning w-full mt-5"><i class="ri-calendar-todo-line text-lg"></i> Menu
									Absensi</button>
							</div>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuPerlengkapan">
								<button id="btnPerlengkapan" class="btn btn-warning w-full mt-5"><i class="ri-tools-line text-lg"></i> Menu
									Perlengkapan</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px]">
										<a href="{{ route('perlengkapan.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-hammer-line text-lg"></i> Index
											Perlengkapan</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuLembur">
								<button id="btnLembur" class="btn btn-warning w-full mt-5"><i class="ri-time-line text-lg"></i> Menu
									Lembur</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px] ">
										<a href="{{ route('lemburList') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-hourglass-2-line text-lg"></i> Index
											Lembur</a>
									</span>
								</div>
							</div>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuJabatan">
								<button id="btnJabatan" class="btn btn-warning w-full mt-5"><i class="ri-medal-line text-lg"></i> Menu
									Jabatan</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px] ">
										<a href="{{ route('jabatan.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-award-line text-lg"></i> Index
											Jabatan</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuHoliday">
								<button id="btnHoliday" class="btn btn-warning w-full mt-5 "><i class="ri-cup-line text-lg"></i> Menu hari
									libur</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px] ">
										<a href="{{ route('holiday.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-flight-takeoff-line text-lg"></i> Index
											holiday</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuLokasi">
								<button id="btnLokasi" class="btn btn-warning w-full mt-5"><i class="ri-road-map-line text-lg"></i> Menu
									Lokasi</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px] ">
										<a href="{{ route('lokasi.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-pin-distance-line text-lg"></i> Index
											Lokasi</a>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuJadwal">
								<button id="btnJadwal" class="btn btn-warning w-full mt-5"><i class="ri-calendar-event-line text-lg"></i>
									Menu Jadwal</button>
							</div>
								...
								<div style="width: 17rem;">
									<span class="flex flex-col justify-center gap-x-2 mx-2 pb-[148px] ">
										<a href="{{ route('admin-jadwal.index') }}"
											class="btn-info hover:bg-sky-500 hover:text-white w-full shadow-md hover:shadow-none text-center uppercase font-semibold text-sm rounded-md px-4 py-2 mt-5 transition-all ease-linear .2s"><i
												class="ri-calendar-2-line text-lg"></i> Index
											Jadwal User</a>
									</span>
								</div>
							</div>
						...
						<div style="width: 17rem;">
							<div class="flex justify-center px-2 menuLaporan">
								<button id="btnLaporan" class="btn btn-warning w-full mt-5"><i class="ri-task-line text-lg"></i> Menu
									Laporan</button>
							</div>
				...
				<div>
					...
					<div class="bg-lime-400 font-semibold shadow mt-5 rounded-tr-md" style="width: 29%;">
						<div class="grid grid-cols py-1">
							<span class="mx-3 pt-2">Status Website : <span class="badge badge-info overflow-hidden"
									id="uptime"></span></span>
