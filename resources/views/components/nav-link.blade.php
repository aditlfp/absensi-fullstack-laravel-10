...
$classes = ($active ?? false)
            ...
            : 'inline-flex text-white items-center w-auto mt-4 h-3/6 px-2 hover:bg-yellow-400 hover:text-white hover:shadow-md rounded-md transition all ease-in-out .2s font-semibold overflow-hidden';
@endphp
