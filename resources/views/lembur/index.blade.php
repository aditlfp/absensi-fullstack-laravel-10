		...
		<div class="mx-5 my-5">
			<form action="{{ route('lembur.store') }}" method="POST" enctype="multipart/form-data">
				...
				<div class="p-2 bg-white rounded-lg">
					...
					<div class="flex flex-col-5 sm:flex-auto">
						@foreach ($dev as $arr)
				...
				<div class="flex flex-col">
					...
					<div class="flex justify-end mt-1">
						<input name="keterangan" type="radio" value="lembur" class="radio cursor-pointer checked:bg-blue-500"><span
							class="mx-2">Lembur</span>
					</div>
				</div>
				<div class="flex flex-col">
					<label for="jam_mulai">Jam Mulai</label>
					<input type="time" name="jam_mulai" id="jam_mulai" class="input input-bordered w-[120px]">
				</div>
				</div>
				@forelse ($lembur as $i)
